...
public class CellulareView {
            ...
            switch (scelta) {
                ...
                case 3 -> {
                    ...
                    switch (modalita) {
                        case 1 -> {
                            {
                                if (!mioTelefono.mostraRubrica()) {
                                    numero = inserisciNumeroNonRubrica();
                                    break;
                                }
                        ...
                        case 2 -> numero = inserisciNumeroNonRubrica();
    ...
    private String inserisciNumeroNonRubrica() {
        System.out.print("Inserisci il numero da chiamare (non presente in rubrica): ");
        return leggiStringa();
    }
